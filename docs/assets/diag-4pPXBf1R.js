import{e as d,c as g,a as m}from"./webrtc-eO6tsEZ1.js";const u=document.getElementById("out"),i=document.getElementById("status"),t=(n,a)=>{u.innerHTML+=`<span class="${n}">${a}</span>
